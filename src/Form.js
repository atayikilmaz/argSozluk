      ...
      <Card color="transparent" shadow={false} className="mx-50%">
        ...
        <form className="mt-8 mb-2 max-w-screen-lg sm:w-96" onSubmit={handleSubmit}>
          ...
          <div className="mb-4 flex flex-col gap-6">
            <Input required size="lg" label="Argüman Başlığı" name="argumanBasligi" />
            <Textarea required size="lg" label="Argüman İçeriği" name="argumanIcerigi" rows={4} />
            <Textarea required size="lg" label="Kaynaklar" name="kaynaklar" />
          </div>
